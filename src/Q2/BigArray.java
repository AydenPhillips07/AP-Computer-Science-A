...
public class BigArray {
    public static void main(String[] args) {
        ...
        // 6. Switch the largset with smallest number. Print the list
        int smallIndex = -1;
        int LargeIndex = -1;
        for (int i = 0; i < array.length; i++){
        ...
        // 9. Replace the 3rd element in the array with 5 and print the number that was ousted (only use one method)
        int myThird = array[2];
        array[2] = 5;
